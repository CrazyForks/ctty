...
// FTP passwords live in ftp-credentials.json (cleartext, 0600) — not the SSH vault.
...
Passwords (insecure cleartext): ~/.config/ctty/ftp-credentials.json — NOT credentials.json.
